...
- `md5sum/`
  - `*.md5`: One MD5 checksum file for each samplesheet input and the rendered Quarto HTML report.
...
- Pipeline, Nextflow, Quarto, and, when installed, Papermill versions.
