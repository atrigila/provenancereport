...
- The name of the rendered Quarto HTML report and its published output path.
- If applicable, a section with the name of the traceability document and its published output path.
